/* Written by Daffabot at github playground with some little help from Ali. https://github.com/daffabot/tank-daffabot.github.io  */
...
var startGame = function ()
{
    ...
    },
    {
        ...
        respawn: false,
        respawnrate: 0.5,
        sprite: new Sprite('images/tank3.png', [68, 434], [230 - 68, 565 - 434], [c.width / 5.8, c.height / 12])
    }];
    ...
    function checkIcons(xx, yy)
    {
        ...
        if (xx > icons[3].pos[0] && xx < icons[3].pos[0] + (k * 5) && yy > icons[3].pos[1] - (k * 3) && yy < icons[3].pos[1] + (k * 3))
        {
           ...
           if(modal.style.display == "block") {
                ...
                p.innerHTML = 'Mohon, untuk donasi 1000 miliyar untuk mendapatkan mesin kematian yang luar biasa, inovatif, dapat diisi ulang secara nirkabel, ramah lingkungan/vegan/gila ini<br/>Arigatou!'; 
    ...
    for (x = 0;x * 102 < c.width;x++) {
        for (y = 0;y * 102 < c.height;y++) { ctx.drawImage(resources.get('images/tile.png'), 0, 0, 512, 512, x*102, y*102,102,102);
        }
    }
    ctx.globalAlpha = 1;
