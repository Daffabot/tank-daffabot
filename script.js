            ...
            function checkIcons(xx, yy) {
                ...
                if (xx > icons[3].pos[0] && xx < icons[3].pos[0] + (k * 5) && yy > icons[3].pos[1] - (k * 3) && yy < icons[3].pos[1] + (k * 3)) {
                    ...
                    if (modal.style.display == "block") {
                        ...
                        p.innerHTML = 'Mohon, untuk donasi 271 Triliun di <a href="https://trakteer.id/daffabot" target="_blank" rel="noopener noreferrer">Trakteer</a> untuk mendapatkan mesin kematian yang luar biasa, inovatif, dapat diisi ulang secara nirkabel, ramah lingkungan ini<br/>Arigatou!';
            ...
            function renderArea(ctx) {
                ...
                for (x = 0; x * 102 < c.width; x++) {
                    for (y = 0; y * 102 < c.height; y++) {
                        ctx.drawImage(resources.get('images/tile.png'), 0, 0, 512, 512, x * 102, y * 102, 102, 102);
                    }
                }
                ctx.globalAlpha = 1;
